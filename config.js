...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "XQMkRZTa#aOm7u71x9-HezTJ4JqIcb_r9jWpTKHL3WKOQ_BMLXh4",
  // ADD Your Session Id 
  MONGODB: process.env.MONGODB || "mongodb+srv://kulathungaasitha319:yjHB0DvFfStNfwPS@cluster0.3oijd.mongodb.net/",
    // ADD Your MongoDB Database URL
  PREFIX: process.env.PREFIX || "coustom.",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94783443503",
  //========================================- OTHER - CONFIGS -=====================================================================
  ...
  packname: process.env.packname || "SADEW TECH",
  author: process.env.author || "SADEW TECH",
  //==========================================- API-CONFIGS -==========================================================
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `🚀 *_SADEW-MD Connected Successfully!_* ✅ 

--- *👨‍💻🎉 _Welcome to SADEW-MD!_* 🎉💗 

*🔹 OWNER:* 94783443503

_Thank you for using_ *👨‍💻SADEW-MD💗.*
_We're here to make your experience enjoyable and seamless._
_If you need any help or have questions, don't hesitate to ask._ 🌝💗

_*👨‍💻 Enjoy your time with us! 😊*_

> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ sadew ᴛᴇᴄʜ*` ,

  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/wssocv.jpg",
  MENU_IMG: process.env.MENU_IMG || "https://files.catbox.moe/wssocv.jpg",
